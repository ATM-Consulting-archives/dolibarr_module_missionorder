 ...
 */
class missionorderbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "missionorder@missionorder";
    public $boxlabel;
    public $depends = array("missionorder");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/missionorder/class/missionorder.class.php";
